...
@section('content')
<h2 style="text-decoration: underline; margin-bottom: 10px; margin-left:60px">Jadwal Audit Backup & Restore Database
</h2>
    ...
    <table style="border-collapse: collapse; width: 100%; min-width: 1200px; text-align: center;">
        <thead>
            <tr style="background-color: #f2f2f2;">
                ...
                <th style="padding: 10px;">Agenda </th>
...
<div id="editForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%;
    ...
    <div style="background-color: white; padding: 20px; border-radius: 10px; 
        ...
        <form id="editMemoForm" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                <label for="edit_kegiatan"><span style="color: red;">*</span>:</label>
...
<div id="popupForm" style="display: none; position: fixed; top: 0; left: 0; 
    ...
    <div style="background-color: white; padding: 20px; border-radius: 10px; 
        ...
        <form action="{{ route('admin.audit.brdb.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                <label for="kegiatan">Agenda<span style="color: red;">*</span>:</label>
...
function editMemo(id) {
    fetch(`/admin/audit-brdb/${id}/edit`) // <-- pakai backtick atau string
        .then(res => res.json())
        .then(data => {
            ...
            form.action = `/admin/audit-brdb/${id}`; // <-- perbaiki jadi string
