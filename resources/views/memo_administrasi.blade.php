...
<form method="GET" action="{{ route('admin.memo.administrasi.index') }}"
  ...
  @if(request('search'))
  <a href="{{ route('admin.memo.administrasi.index') }}"
    ...
    <tr>
      ...
      <td style="padding: 10px; font-size: 11px;">
        <div style="display: inline-flex; justify-content: center; gap: 10px; flex-wrap: wrap; align-items: center;">
          ...
          <!-- Hapus -->
          <form action="{{ route('admin.memo.administrasi.destroy', $item->id) }}" method="POST"
...
<div id="popupForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%;
  ...
  <div
    ...
    <form action="{{ route('admin.memo.administrasi.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div style="margin-bottom: 15px;">
