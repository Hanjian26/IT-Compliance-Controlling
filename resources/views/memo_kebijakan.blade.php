  ...
  <div
    ...
    <form id="editMemoForm" method="POST" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="tipe_memo" id="edit_tipe_memo" value="Kebijakan" readonly
  ...
  <div
    ...
    <form action="{{ route('memo.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="tipe_memo" id="tipe_memo" value="Kebijakan" readonly
          style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; cursor: not-allowed;">
      </div>
...
<script>
  function openPopup() {
    ...
    fetch("{{ route('memo.kebijakan.generateNomor') }}")
        .then(res => res.json())
        .then(data => {
