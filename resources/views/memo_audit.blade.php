  ...
  <div
    ...
    <form id="editMemoForm" method="POST" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="tipe_memo" id="edit_tipe_memo" value="Audit" readonly
  ...
  <div
    ...
    <form action="{{ route('memo.audit.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="tipe_memo" id="tipe_memo" value="Audit" readonly
          style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; cursor: not-allowed;">
      </div>
...
function generateNomorFromTanggal() {
    ...
    fetch("{{ route('memo.audit.generateNomor') }}?tanggal=" + tgl)
        .then(res => res.json())
        .then(data => {
...
function generateNomorFromTanggalEdit() {
  ...
  function editMemo(id) {
    fetch(`/admin/memo-audit/${id}/edit`)
      .then(res => res.json())
      .then(data => {
        ...
        form.action = `/admin/memo-audit/${id}`;
