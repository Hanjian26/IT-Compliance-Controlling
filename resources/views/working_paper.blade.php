    ...
    {{ $item->status }}
        ...
        <td style="padding: 10px; font-size: 11px;">
          ...
          <!-- Edit -->
            ...
            <!-- Hapus -->
            <form action="{{ route('audit.wp.destroy', $item->id) }}" method="POST" onsubmit="return confirmDelete()" style="display: inline;">
              @csrf
              @method('DELETE')
...
<div id="editForm" 
  ...
  <div style="margin-bottom: 15px;">
       ...
       onkeydown="return false" required style="width: 100%; padding: 8px;"style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>

      <div style="margin-bottom: 15px;">
       <label for="edit_tanggal_selesai">Tanggal Selesai:</label>
        <input type="date" name="tanggal_selesai" id="edit_tanggal_selesai" 
              lang ="id" min="2000-01-01" max="2099-12-31"
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="auditor" id="edit_auditor" required style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="edit_reviewer">Reviewer<span style="color: red;">*</span>:</label>
        <input type="text" name="reviewer" id="edit_reviewer" required style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>
 ...
 <div style="margin-bottom: 15px;">
      ...
      <input type="file" name="file_wp" id="edit_file_wp" accept=".pdf,.doc,.docx,.zip" style="width: 100%; padding: 6px;">
      ...
      <div style="display: flex; justify-content: flex-end; gap: 10px; flex-wrap: wrap;">
        <button type="button" onclick="closeEdit()" 
                style="background-color: #e0e0e0; color: black; padding: 8px 14px; cursor: pointer; 
                       border: none; border-radius: 4px;">
          Batal
        </button>
        <button type="submit"
                style="background-color: #4caf50; color: white; padding: 8px 14px; cursor: pointer; 
                       border: none; border-radius: 4px;">
          Perbarui
        </button>
      </div>
...
<div id="popupForm" 
    ...
    <form action="{{ route('audit.wp.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 15px;">
       <label for="kegiatan">Kegiatan<span style="color: red;">*</span>:</label>
        <input type="text" name="kegiatan" id="kegiatan" required style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>
      ...
      <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="auditor" id="auditor" required style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="reviewer">Reviewer<span style="color: red;">*</span>:</label>
        <input type="text" name="reviewer" id="reviewer" required style="width: 100%; padding: 8px; box-sizing: border-box;">
      </div>
 ...
 <div style="margin-bottom: 15px;">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <textarea name="keterangan" id="keterangan" rows="2" style="width: 100%; padding: 8px; box-sizing: border-box;"></textarea>
      </div>
