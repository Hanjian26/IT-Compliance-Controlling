...
<table style="border-collapse: collapse; width: 100%; text-align: center;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="padding: 10px; font-size: 12px;">{{ \Carbon\Carbon::parse($item->tanggal_terbit)->format('d/m/Y') }}
      </td>
      ...
      <td style="padding: 10px; font-size: 11px;">
        <div style="display: inline-flex; justify-content: center; gap: 10px; flex-wrap: wrap; align-items: center;">
          ...
          <!-- Hapus -->
          <form action="{{ route('memo.audit.destroy', $item->id) }}" method="POST" onsubmit="return confirmDelete()"
...
@if (session('success'))
<div
  style="position: fixed; bottom: 20px; right: 20px; background-color: #4CAF50; color: white; padding: 12px 20px; border-radius: 5px; z-index: 9999;">
  {{ session('success') }}
</div>
@endif
