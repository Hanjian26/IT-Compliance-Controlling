    ...
    public function index(Request $request)
{
    ...
    return view('laporan_hasil_audit', compact('data'));
}
        ...
        public function store(Request $request)
    {
        ...
        $audit->file_lha = $request->file_lha;
        ...
        activity('laporan_hasil_audit')
            ...
            ->log('Menambahkan Menambahkan Laporan Hasil Audit');

        return redirect()->back()->with('success', 'Laporan Hasil Audit Audit berhasil ditambahkan!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('audit.lha')->with('success', 'Data data laporan hasil audit berhasil dihapus.');
    }
