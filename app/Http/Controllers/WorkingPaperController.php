    ...
    public function index(Request $request)
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.audit.working-paper.index')->with('success', 'Data working paper audit berhasil dihapus.');
    }
  ...
  public function update(Request $request, $id)
{
    ...
    return redirect()->route('admin.audit.working-paper.index')->with('success', 'Working Paper Audit berhasil diperbarui!');
}
