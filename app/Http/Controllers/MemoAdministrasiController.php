...
{
    $query = Memos::where('tipe_memo', 'Administrasi');
    ...
    public function store(Request $request)
    {
        ...
        activity('memo_administrasi')
            ...
            ->log('Menambahkan memo administrasi');
    ...
    public function destroy($id)
    {
        ...
        activity('memo_administrasi')
            ...
            ->log('Menghapus memo administrasi');
        ...
        return redirect()->route('memo.administrasi')->with('success', 'Dokumen berhasil dihapus.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        activity('memo_administrasi')
            ...
            ->log('Memperbarui memo administrasi');

        return redirect()->route('memo.administrasi')->with('success', 'Memo berhasil diperbarui!');
    }
...
public function generateNomor(Request $request)
{
    ...
    return response()->json([
        'nomor' => KodeMemoHelper::generate('Administrasi', $tanggal)
    ]);
}
