    ...
    public function index(Request $request)
{
     ...
     * =============================== */
     $approvedQuery = Memos::where('tipe_memo', 'Permintaan Data')
     ...
     * =============================== */
    $pendingQuery = Memos::where('tipe_memo', 'Permintaan Data')
        ->where('status', 'pending');

         $pendingQuery = Memos::where('memos.tipe_memo', 'Permintaan Data')
     ...
     * RETURN VIEW
     * =============================== */
    return view('memo_permintaan_data', [
            'data'        => $approvedData,
