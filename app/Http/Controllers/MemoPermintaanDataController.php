...
class MemoPermintaanDataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        activity('memo_permintaan_data')
            ...
            ->log('Menambahkan memo permintaan data');
    ...
    public function destroy($id)
    {
        ...
        activity('memo_permintaan_data')
            ...
            ->log('Menghapus memo permintaan data');
        ...
        return redirect()->route('memo.permintaan.data')->with('success', 'Dokumen berhasil dihapus.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        activity('memo_permintaan_data')
            ...
            ->log('Memperbarui memo permintaan data');

        return redirect()->route('memo.permintaan.data')->with('success', 'Memo berhasil diperbarui!');
    }
public function generateNomor(Request $request)
{
    ...
    return response()->json([
        'nomor' => KodeMemoHelper::generate('Permintaan Data', $tanggal)
    ]);
}
}