    ...
    public function index(Request $request)
{
     ...
     * =============================== */
     $approvedQuery = Memos::where('tipe_memo', 'Penemuan')
     ...
     * =============================== */
    $pendingQuery = Memos::where('tipe_memo', 'Penemuan')
        ->where('status', 'pending');

         $pendingQuery = Memos::where('memos.tipe_memo', 'Penemuan')
